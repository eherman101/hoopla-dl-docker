...
def WV_Function(pssh, lic_url, x_dt_auth_token, params=None, cert_b64=None):
...
# basic, mostly sites works
	responses.append(requests.post(url=lic_url, headers=headers, data=raw_request, params=params))
